...
function maw_register_guten_script() {
  ...
  wp_register_script( 'swiper', get_template_directory_uri() .'/node_modules/swiper/swiper-bundle.min.js'); 
  wp_register_script( 'effects', get_template_directory_uri() .'/template-part/block/swiper-material/effect-material.min.js');
  wp_register_script( 'material-slider', get_template_directory_uri() .'/template-part/block/swiper-material/slider.js', [ 'swiper' ,'effects' , 'acf' ]);
  wp_register_script( 'project-slider', get_template_directory_uri() .'/template-part/block/swiper-projects/project-slider.js', [ 'swiper' ,'effects' , 'acf' ]);
}
